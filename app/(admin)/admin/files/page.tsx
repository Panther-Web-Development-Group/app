...
export default async function AdminFilesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-3xl font-bold text-foreground">Files</h2>
        <p className="mt-2 text-foreground/75">
          Manage document/other assets stored in `media_assets`.
        </p>
      </div>
      ...
      {!user ? (
        <div className="rounded-lg border border-(--pw-border) bg-secondary/20 p-12 text-center">
          <p className="text-foreground/75">Please sign in to manage files.</p>
        </div>
      ) : !assets || assets.length === 0 ? (
        <div className="rounded-lg border border-(--pw-border) bg-secondary/20 p-12 text-center">
          <p className="text-foreground/75">No files yet.</p>
        </div>
      ) : (
