...
export interface GalleryFloatingMenuProps {
  nodeKey: string
  onClose: () => void
  onEdit?: () => void
}

/** Floating menu content for a Gallery block. Placeholder until GalleryNode is wired. */
export function GalleryFloatingMenu({ onClose, onEdit }: GalleryFloatingMenuProps) {
  return (
