...
import type { TextAreaGroupProps } from "./types"
...
export const TextAreaGroup: FC<TextAreaGroupProps> = (props) => {
  const {
    className,
    ...
    <div className={cn("space-y-1.5", className)}>
      ...
      <div className="relative">
        ...
        <TextArea
          ...
          className={cn(
            "min-h-20 w-full rounded-lg border border-(--pw-border) bg-background/10 px-3 py-2 text-sm text-foreground outline-none",
            "transition-colors",
